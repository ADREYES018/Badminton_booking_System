/**
 * Horizontal Smash Club lockup. Default mark for headers, nav and emails.
 * Generated from Logos/BLACK_LOGO_HORIZONTAL.svg. Brand strokes are rewritten to `currentColor`, so the
 * mark follows the surrounding text colour: near-black on light surfaces,
 * Electric Lime on dark.
 */
